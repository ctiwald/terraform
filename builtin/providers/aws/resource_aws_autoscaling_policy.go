...
// PutScalingPolicy seems to require all params to be resent, so create and
// update can share this common function. This function will error if certain
// mutually exclusive values are set.
